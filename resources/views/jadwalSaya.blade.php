...
<head>
    ...
    <title>SATOEFL | Jadwal Saya</title>
...
<body>
        ...
        <div class="container" style="margin-top: 10px">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="jadwalSaya">Jadwal Saya</a>
                    </li>
    ...
    <div class="row" style="margin: 20px">
        <div class="col-lg-12 col-12">
            <h4 class=" text-center">My <u class="text-info">Schedules</u></h4>
        </div>
    </div>
        ...
        <tbody>
            @foreach ($jadwalS as $jadwal)
                <tr>
                   ...
                   <form id="jadwals-form" {{ route('detail.jadwal')}} method="POST">
                            @csrf
                            <input type="hidden" name="transaksi_id" value="{{$jadwal->transaksi_id}}">
                            <input type="hidden" name="name" value="{{ $jadwal->nama }}">
                            <input type="hidden" name="jadwal" value="{{ $jadwal->jadwal }}">
                        </form>
                    <td>
                        <a href="detailJadwal" target="__blank" >
                            <button class="btn btn register mb-2" style="background: #87b1df; color:#ffffff;">Print Participant Cards</button>
                        </a>
                        <br>    
                    </td>
                </tr>
